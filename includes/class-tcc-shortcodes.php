...
<div style="display:grid; grid-template-columns: 1fr 1fr; gap:10px; margin-bottom:20px;">
    <div>
        <input type="radio" name="calc_mode" id="mode_custom" value="custom" checked class="tcc-hidden-radio-main" style="display: none !important; opacity: 0 !important; position: absolute !important; width: 0 !important; height: 0 !important;">
        <label for="mode_custom" class="fd-date-btn-modern tcc-mode-label-main" style="margin: 0; width: 100%; height: 100% !important;">
            <span class="fd-date-main-text" style="font-size: 13px !important; margin: 0 !important;">Custom Quote</span>
            <div class="fd-date-check">&#10003;</div>
        </label>
    </div>
    
    <div>
        <input type="radio" name="calc_mode" id="mode_fixed" value="fixed" class="tcc-hidden-radio-main" style="display: none !important; opacity: 0 !important; position: absolute !important; width: 0 !important; height: 0 !important;">
        <label for="mode_fixed" class="fd-date-btn-modern tcc-mode-label-main" style="margin: 0; width: 100%; height: 100% !important;">
            <span class="fd-date-main-text" style="font-size: 13px !important; margin: 0 !important;">Group Tours</span>
            <div class="fd-date-check">&#10003;</div>
        </label>
    </div>
</div>

            <div id="tcc-fixed-departure-wrapper" style="display:none;">
                <div class="tcc-card" style="border-left: 4px solid #4338ca;">
                    <div class="tcc-card-title">Select Group Tour & Pax Details</div>
                    
                    <div class="tcc-grid-3" style="margin-bottom: 10px; border-bottom:1px dashed #cbd5e1; padding-bottom:10px;">
                        <div class="tcc-form-group">
                            <label>Client Name</label>
                            <input type="text" id="fd_client_name" placeholder="E.g. Rahul Sharma">
                        </div>
                        <div class="tcc-form-group">
                            <label>WhatsApp Number</label>
                            <input type="text" id="fd_client_phone" placeholder="+91 XXXXX XXXXX">
                        </div>
                        <div class="tcc-form-group">
                            <label>Email</label>
                            <input type="email" id="fd_client_email" placeholder="client@email.com">
                        </div>
                    </div>

                    <div class="tcc-form-group">
                        <label>Upcoming Tours</label>
                        <select id="fd_select_tour">
                            <option value="">-- Loading Tours... --</option>
                        </select>
                        <div id="fd_date_selection_wrapper" style="display:none; margin-top:10px; padding:10px; background:#f8fafc; border:1px dashed #cbd5e1; border-radius:4px;">
                            <label style="font-size:12px; font-weight:bold; color:#475569; margin-bottom:8px; display:block;">Select Departure Date:</label>
                            <div id="fd_date_buttons" style="display:flex; flex-wrap:wrap; gap:8px;"></div>
                            <input type="hidden" id="fd_selected_start_date" value="">
                            <input type="hidden" id="fd_selected_end_date" value="">
                        </div>
                    </div>
                    
<div class="tcc-grid-3">
                        <div class="tcc-form-group">
                            <label>Double Sharing Pax</label>
                            <div class="tcc-qty-wrapper">
                                <button type="button" class="tcc-qty-btn minus">-</button>
                                <input type="number" id="fd_pax_double" min="0" step="2" value="0" readonly tabindex="-1" style="pointer-events:none; background:transparent;">
                                <button type="button" class="tcc-qty-btn plus">+</button>
                            </div>
                        </div>
                        <div class="tcc-form-group">
                            <label>Triple Sharing Pax</label>
                            <div class="tcc-qty-wrapper">
                                <button type="button" class="tcc-qty-btn minus">-</button>
                                <input type="number" id="fd_pax_triple" min="0" step="3" value="0" readonly tabindex="-1" style="pointer-events:none; background:transparent;">
                                <button type="button" class="tcc-qty-btn plus">+</button>
                            </div>
                        </div>
                        <div class="tcc-form-group">
                            <label>Single Sharing Pax</label>
                            <div class="tcc-qty-wrapper">
                                <button type="button" class="tcc-qty-btn minus">-</button>
                                <input type="number" id="fd_pax_single" min="0" step="1" value="0" readonly tabindex="-1" style="pointer-events:none; background:transparent;">
                                <button type="button" class="tcc-qty-btn plus">+</button>
                            </div>
                        </div>
                    </div>
                    <div class="tcc-grid-2">
                        <div class="tcc-form-group">
                            <label>Child (6-12) w/o Bed</label>
                            <div class="tcc-qty-wrapper">
                                <button type="button" class="tcc-qty-btn minus">-</button>
                                <input type="number" id="fd_pax_child" min="0" value="0" readonly tabindex="-1" style="pointer-events:none; background:transparent;">
                                <button type="button" class="tcc-qty-btn plus">+</button>
                            </div>
                        </div>
                        <div class="tcc-form-group">
                            <label>Infant (<6)</label>
                            <div class="tcc-qty-wrapper">
                                <button type="button" class="tcc-qty-btn minus">-</button>
                                <input type="number" id="fd_pax_infant" min="0" value="0" readonly tabindex="-1" style="pointer-events:none; background:transparent;">
                                <button type="button" class="tcc-qty-btn plus">+</button>
                            </div>
                        </div>
                    </div>

                    <div class="tcc-form-group" style="border-top:1px dashed #cbd5e1; padding-top:10px;">
                        <label>Discount on Booking</label>
                        <div style="display:flex; gap:5px;">
                            <select id="fd_discount_type" style="flex:1;"><option value="none">Off</option><option value="flat">Flat (₹)</option><option value="percent">% Percent</option></select>
                            <input type="number" id="fd_discount_val" value="0" min="0" style="flex:2;">
                        </div>
                    </div>
                </div>
                
                <div style="background:#eef2ff; padding:15px; border-radius:6px; border:1px solid #c7d2fe; text-align:right;">
                    <span style="font-size:14px; color:#4338ca; font-weight:bold;">Final Group Value:</span>
                    <span id="fd_live_total" style="font-size:24px; color:#312e81; font-weight:900; margin-left:10px;">₹0.00</span>
                </div>
            </div>

            <div id="tcc-custom-quote-wrapper">
                        ...
                        <div class="tcc-step-accordion-body" style="display:none; margin-top:10px; border-top:1px dashed #e2e8f0; padding-top:10px;">
                            ...
                            <div class="tcc-form-group">
                                ...
                                <div class="tcc-quill-wrapper" style="background: #fff; border: 1px solid #cbd5e1; border-radius: 4px;">
                                    <div class="tcc-quill-editor" id="quote_inclusions_editor" style="min-height: 100px; font-size: 13px;"></div>
                            ...
                            <div class="tcc-form-group" style="margin-top:10px;">
                                ...
                                <div class="tcc-quill-wrapper" style="background: #fff; border: 1px solid #cbd5e1; border-radius: 4px;">
                                    <div class="tcc-quill-editor" id="quote_exclusions_editor" style="min-height: 100px; font-size: 13px;"></div>
                            ...
                            <div class="tcc-form-group" style="margin-top:10px;">
                                ...
                                <div class="tcc-quill-wrapper" style="background: #fff; border: 1px solid #cbd5e1; border-radius: 4px;">
                                    <div class="tcc-quill-editor" id="quote_payment_terms_editor" style="min-height: 100px; font-size: 13px;"></div>
                            ...
                            <div class="tcc-form-group" style="margin-top:10px;">
                                ...
                                <div class="tcc-quill-wrapper" style="background: #fff; border: 1px solid #cbd5e1; border-radius: 4px;">
                                    <div class="tcc-quill-editor" id="quote_important_note_editor" style="min-height: 100px; font-size: 13px;"></div>
                                    <textarea name="quote_important_note" id="quote_important_note" style="display:none;"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="tcc-form-group" style="margin-top:10px;">
                                ...
                                <div class="tcc-quill-wrapper" style="background: #fff; border: 1px solid #cbd5e1; border-radius: 4px;">
                                    <div class="tcc-quill-editor" id="quote_why_choose_us_editor" style="min-height: 100px; font-size: 13px;"></div>
                                    <textarea name="quote_why_choose_us" id="quote_why_choose_us" style="display:none;"></textarea>
                                </div>
                            </div>

                            <div class="tcc-form-group" style="margin-top:10px;">
                                <label>Essential Travel Guidelines</label>
                                <div class="tcc-quill-wrapper" style="background: #fff; border: 1px solid #cbd5e1; border-radius: 4px;">
                                    <div class="tcc-quill-editor" id="quote_essential_guidelines_editor" style="min-height: 100px; font-size: 13px;"></div>
                                    <textarea name="quote_essential_guidelines" id="quote_essential_guidelines" style="display:none;"></textarea>
                                </div>
                            </div>

                            <div class="tcc-form-group" style="margin-top:10px;">
                                <label>Operational Head Office Address</label>
                                <textarea name="quote_head_office" id="quote_head_office" rows="3" style="width:100%; border:1px solid #cbd5e1; border-radius:3px; padding:6px; font-size:13px;"></textarea>
                            </div>
                ...
                <div class="tcc-card" style="border-color: #bee3f8; background:#f0f9ff; margin-top:20px;">
                    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:10px; border-bottom:1px solid #bae6fd; padding-bottom:8px;">
                        <div class="tcc-card-title" style="color:#0369a1; border-bottom:none; margin-bottom:0; padding-bottom:0;">Final Adjustments & Overview</div>
                    </div>

                    <div style="background:#e0f2fe; padding:10px; border-radius:4px; border:1px solid #bae6fd; margin-bottom:10px; font-size:12px; color:#0369a1;">
                        ...
                        <div id="live_actual_cost_breakdown" style="font-size:10px; color:#0284c7; text-align:right; margin-top:2px; font-weight:normal; display:none;"></div>
                    </div>

                    <div style="display:grid; grid-template-columns: repeat(3, 1fr); gap:10px; margin-bottom:15px;">
                        <label style="display:flex; justify-content:center; align-items:center; font-weight:bold; font-size:11px; cursor:pointer; color:#0369a1; background:#e0f2fe; padding:8px 5px; border-radius:4px; border:1px solid #7dd3fc; margin:0;">
                            <input type="checkbox" name="hide_travelers_rooms" id="hide_travelers_rooms" value="1" style="margin:0 6px 0 0 !important; padding:0; cursor:pointer; position:static; width:13px !important; height:13px !important; flex-shrink:0;">
                            <span style="display:inline-block; line-height:1.2; text-align:left;">Hide Travelers & Rooms</span>
                        </label>
                        <label style="display:flex; justify-content:center; align-items:center; font-weight:bold; font-size:11px; cursor:pointer; color:#0369a1; background:#e0f2fe; padding:8px 5px; border-radius:4px; border:1px solid #7dd3fc; margin:0;">
                            <input type="checkbox" name="hide_pricing" id="hide_pricing" value="1" style="margin:0 6px 0 0 !important; padding:0; cursor:pointer; position:static; width:13px !important; height:13px !important; flex-shrink:0;">
                            <span style="display:inline-block; line-height:1.2; text-align:left;">Hide Pricing Section</span>
                        </label>
                        <label style="display:flex; justify-content:center; align-items:center; font-weight:bold; font-size:11px; cursor:pointer; color:#0369a1; background:#e0f2fe; padding:8px 5px; border-radius:4px; border:1px solid #7dd3fc; margin:0;">
                            <input type="checkbox" name="share_cab_cost" id="share_cab_cost" value="1" style="margin:0 6px 0 0 !important; padding:0; cursor:pointer; position:static; width:13px !important; height:13px !important; flex-shrink:0;">
                            <span style="display:inline-block; line-height:1.2; text-align:left;">Share Cab Cost</span>
                        </label>
                    </div>
                    ...
                    <div class="tcc-preview-panel">
                        <div class="tcc-grid-2" style="margin-bottom:0;">
                            <div>
                                ...
                                <div id="live_pp_base_breakdown" style="font-size:10px; color:#64748b; margin-top:2px; display:none;"></div>
                            </div>
                        ...
                        <div class="tcc-preview-sub" style="border-top: 1px dashed #cbd5e1; padding-top: 8px; margin-top: 8px; display:flex; justify-content:space-between; gap:5px; flex-wrap:wrap;">
                            <div style="display:flex; flex-direction:column;">
                                ...
                                <span id="live_pp_inc_breakdown" style="font-size:10px; color:#64748b; font-weight:normal; margin-top:2px; display:none;"></span>
                            </div>
            ...
            </div> <button type="submit" id="tcc_calculate_btn" class="tcc-btn-primary">Generate Quote Link</button>
        </form>

        <div id="tcc_link_wrapper" style="display:none; text-align:center; padding:15px 12px; background:#d4edda; border-radius:6px; margin-top:15px; border:1px solid #c3e6cb;">
            <h3 style="color:#155724; margin:0 0 12px 0; font-size:15px;">✅ Quote Generated Successfully!</h3>
            <div style="display:flex; flex-wrap:wrap; gap:8px; justify-content:center;">
                <button type="button" id="tcc_copy_btn" style="flex:1; min-width:120px; padding:9px 12px; background:#f1f5f9; color:#334155; border:1px solid #cbd5e1; border-radius:5px; font-size:13px; font-weight:700; cursor:pointer;">📋 Copy Link</button>
                <button type="button" id="tcc_pdf_download" style="flex:1; min-width:120px; padding:9px 12px; background:linear-gradient(135deg,#dc2626,#991b1b); color:#fff; border:none; border-radius:5px; font-size:13px; font-weight:700; cursor:pointer; box-shadow:0 2px 4px rgba(220,38,38,.25);">📥 Download PDF</button>
                <button type="button" id="tcc_pdf_share" style="display:none; flex:1; min-width:120px; padding:9px 12px; background:linear-gradient(135deg,#8b5cf6,#6d28d9); color:#fff; border:none; border-radius:5px; font-size:13px; font-weight:700; cursor:pointer; box-shadow:0 2px 4px rgba(139,92,246,.25);">📤 Share PDF</button>
                <a href="#" id="tcc_open_btn" target="_blank" style="flex:1; min-width:120px; padding:9px 12px; background:#0f172a; color:#fff; border:1px solid #0f172a; border-radius:5px; font-size:13px; font-weight:700; cursor:pointer; text-decoration:none; display:inline-block; box-sizing:border-box;">🔗 Open</a>
            </div>
        </div>
...
// --- ADD THE MISSING FUNCTION DECLARATION HERE ---
function tcc_render_settings_dashboard() {
    if ( ! is_user_logged_in() ) {
        return '<div style="padding:40px; text-align:center; color:#dc2626; font-family:sans-serif; background:#fee2e2; border:1px solid #f87171; border-radius:6px; margin:20px 0;"><strong>Access Denied:</strong> Please log in to access settings.</div>';
    }
    ...
    ob_start(); ?>
        ...
        <div class="tcc-wrapper tcc-form">
            <script>
                var tccMasterData = <?php echo wp_json_encode($master_data); ?>;
                var tccGlobalSettings = <?php echo wp_json_encode($global_settings); ?>;
            </script>
            <div id="tcc_settings_msg" style="display:none; padding:10px; margin-bottom:15px; background:#d4edda; color:#155724; border:1px solid #c3e6cb; border-radius:4px; text-align:center; font-weight:bold;"></div>
        ...
        <div class="tcc-accordion">
            ...
            <div class="tcc-accordion-body">
                <form id="tcc-master-settings-form">
                    ...
                    <div class="tcc-form-group"><label>Daily Routes for Itinerary (Comma Sep)</label><input type="text" name="master_daily_routes" id="master_daily_routes" placeholder="Jammu, Katra, Srinagar, Gulmarg, Tour End"></div>
                    ...
                    <div class="tcc-form-group" style="margin-top:10px;">
                        <label>Inclusions</label>
                        <div class="tcc-quill-wrapper" style="background: #fff; border: 1px solid #cbd5e1; border-radius: 4px;">
                            <div class="tcc-quill-editor" id="master_inclusions_editor" style="min-height: 100px; font-size: 13px;"></div>
                    ...
                    <div class="tcc-form-group" style="margin-top:10px;">
                        <label>Exclusions</label>
                        <div class="tcc-quill-wrapper" style="background: #fff; border: 1px solid #cbd5e1; border-radius: 4px;">
                            <div class="tcc-quill-editor" id="master_exclusions_editor" style="min-height: 100px; font-size: 13px;"></div>
                    ...
                    <div class="tcc-form-group" style="margin-top:10px;">
                        <label>Payment Terms</label>
                        <div class="tcc-quill-wrapper" style="background: #fff; border: 1px solid #cbd5e1; border-radius: 4px;">
                            <div class="tcc-quill-editor" id="master_payment_terms_editor" style="min-height: 100px; font-size: 13px;"></div>
                    ...
                    <div class="tcc-form-group" style="margin-top:10px;">
                        <label>Important Note</label>
                        <div class="tcc-quill-wrapper" style="background: #fff; border: 1px solid #cbd5e1; border-radius: 4px;">
                            <div class="tcc-quill-editor" id="master_important_note_editor" style="min-height: 100px; font-size: 13px;"></div>
                            <textarea name="master_important_note" id="master_important_note" style="display:none;"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="tcc-form-group" style="margin-top:10px;">
                        <label>Why Choose Us</label>
                        <div class="tcc-quill-wrapper" style="background: #fff; border: 1px solid #cbd5e1; border-radius: 4px;">
                            <div class="tcc-quill-editor" id="master_why_choose_us_editor" style="min-height: 100px; font-size: 13px;"></div>
                            <textarea name="master_why_choose_us" id="master_why_choose_us" style="display:none;"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="tcc-form-group" style="margin-top:10px;">
                        <label>Essential Travel Guidelines</label>
                        <div class="tcc-quill-wrapper" style="background: #fff; border: 1px solid #cbd5e1; border-radius: 4px;">
                            <div class="tcc-quill-editor" id="master_essential_guidelines_editor" style="min-height: 100px; font-size: 13px;"></div>
                            <textarea name="master_essential_guidelines" id="master_essential_guidelines" style="display:none;"></textarea>
                        </div>
                    </div>
                    
                    <div class="tcc-form-group" style="margin-top:10px;">
                        <label>Operational Head Office Address</label>
                        <textarea name="master_head_office" id="master_head_office" rows="3" style="width:100%; border:1px solid #cbd5e1; border-radius:3px; padding:6px; font-size:13px;"></textarea>
                    </div>
        ...
        <div class="tcc-accordion">
            ...
            <div class="tcc-accordion-body">
                <form id="tcc-settings-form">
                    ...
                    <div class="tcc-form-group" style="margin-top:10px; border-top:1px dashed #ccc; padding-top:10px;">
                        <label style="color:#0369a1;">Additional Room Categories (e.g., Super Deluxe, Suite)</label>
                        <div id="hotel-room-types-wrapper"></div>
                        <button type="button" id="add_hotel_room_type_btn" class="tcc-btn-secondary" style="font-size:11px; padding:4px 8px; margin-top:5px;">+ Add Room Category</button>
                    </div>
